...
const naturalizeNote = (note: string, playTitle: string) => {
  ...
  const learningRules: Array<[RegExp, string]> = [
    [/우드락|판화|새기|찍어내|롤러/, "선을 새기고 물감을 묻혀 찍어내는 과정을 반복하며 판화의 원리와 재료에 따른 표현의 차이를 경험해보았어요."],
    ...
    [/(소리|노래|악기|리듬|천둥|귀뚜라미)/, "주변에서 들리는 소리의 특징을 비교하고 몸짓과 말, 도구를 활용해 자신만의 방법으로 표현해보았어요."],
    ...
    [/(물놀이|물총|물길|얼음|거품|파도)/, "물의 흐름과 움직임을 몸으로 느끼고 도구에 따라 달라지는 변화를 탐색하며 즐겁게 놀이해보았어요."],
    [/(꽃|나뭇잎|나무|숲|곤충|흙|돌|열매|자연)/, "자연물의 모양과 색, 촉감을 자세히 살펴보고 발견한 특징을 놀이와 표현으로 이어가 보았어요."],
    ...
    [/(달리기|점프|균형|공|신체|몸짓|춤|체조)/, "몸의 움직임과 공간의 변화를 느끼며 움직임을 조절하고 친구와 함께하는 즐거움을 경험해보았어요."],
    [/(요리|반죽|썰기|섞기|간식|음식)/, "재료의 모양과 냄새, 질감이 달라지는 과정을 살펴보고 순서와 약속을 지키며 함께 완성해보았어요."],
    [/(실험|자석|빛|그림자|관찰|측정|돋보기)/, "궁금한 점을 직접 시험하고 변화를 자세히 관찰하며 자신의 생각을 말로 설명해보았어요."],
    [/(사진|카메라|만화|장면|순서)/, "관찰한 모습을 사진과 장면으로 담고 순서를 연결하며 자신만의 이야기를 구성해보았어요."],
    [/(그림|색|물감|미술|꾸미|그리|만들기)/, "재료의 색과 질감, 표현 방법의 차이를 탐색하며 떠오른 생각과 느낌을 자신만의 모습으로 나타내보았어요."],
  ];
